...
class _NewEntryPageState extends State<NewEntryPage> {
  ...
  Future<void> scheduleNotification(Medicine medicine) async {
    // Parse the starting hour and minute from the medicine start time
    ...
    // Schedule notifications based on the interval
    for (int i = 0; i < (24 / medicine.interval!).floor(); i++) {
      ...
      // Convert to TZDateTime and schedule the notification
      ...
      // Reset the hour to the original value for the next iteration
      hour = originalHour;
    }
  }
}
